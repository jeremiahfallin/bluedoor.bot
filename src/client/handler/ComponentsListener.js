    ...
    client.on("interactionCreate", async (interaction) => {
      ...
      try {
        if (interaction.isButton()) {
          // Check if customId starts with 'result_' to handle dynamic IDs
          let component;
          if (interaction.customId.startsWith("result_")) {
            component = client.collection.components.buttons.get("result");
          } else {
            component = client.collection.components.buttons.get(
