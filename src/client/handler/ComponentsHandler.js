        ...
        try {
          ...
          if (module.__type__ === 3) {
            ...
            switch (module.type) {
              ...
              case "button": {
                // Check if the customId follows a dynamic pattern like 'result_'
                if (module.customId.startsWith("result_")) {
                  // Use a general key like 'result' for these buttons
                  this.client.collection.components.buttons.set(
                    "result",
                    module
                  );
                } else {
                  // Otherwise, store the button by its specific customId
                  this.client.collection.components.buttons.set(
                    module.customId,
                    module
                  );
